...
public class TestScores {
    ...
    {  
        ...
        if (arrayToStoreGradesGotten[0] == 101 || arrayToStoreGradesGotten[2] == -87 || arrayToStoreGradesGotten[3] == -2 )
        {
    ...
    public TestScores()
    {
     ...
     private int[] array;
    public TestScores(int[] testScore) throws IllegalArgumentException
    {
